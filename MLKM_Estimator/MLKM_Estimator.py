...
np.savetxt(history_dat.format(L = LENGTH_OF_TIME, model = MODEL, label = LABEL, trial = TRIAL), hist, fmt = "%e")
...
np.savetxt(outputs_dat.format(L = LENGTH_OF_TIME, model = MODEL, label = LABEL, trial = TRIAL), outputs, fmt = "%e")
